 ...
 *  map         : map element (optional)
 */

function pm_Marker_Layer(map){
    ...
    this.load_json = function(json){
        ...
        if(o.map){
            ...
            for( var key in o.marker_group){
                o.marker_group[key]= L.featureGroup(o.marker_group[key]).addTo(o.layer); // add new markers
            }
           // o.layer.addTo(map);
        }
    }
